...
plt.figure(figsize=(10, 6))
sns.barplot(x=product_qty.values, y=product_qty.index, hue=product_qty.index, palette='mako', legend=False)
...
plt.figure(figsize=(10, 6))
sns.barplot(x=product_rev.values, y=product_rev.index, hue=product_rev.index, palette='rocket', legend=False)
...
fig, axes = plt.subplots(1, 3, figsize=(18, 5))
sns.boxplot(x='Cluster', y='Recency', data=customer_data, ax=axes[0], hue='Cluster', palette='Set2', legend=False)
axes[0].set_title('Recency by Cluster')
axes[0].set_xlabel('Cluster')
axes[0].set_ylabel('Recency (Days)')
sns.boxplot(x='Cluster', y='Frequency', data=customer_data, ax=axes[1], hue='Cluster', palette='Set2', legend=False)
axes[1].set_title('Frequency by Cluster')
axes[1].set_xlabel('Cluster')
axes[1].set_ylabel('Frequency (Purchases)')
sns.boxplot(x='Cluster', y='Monetary', data=customer_data, ax=axes[2], hue='Cluster', palette='Set2', legend=False)
