...
sns.barplot(x=country_sales.values, y=country_sales.index, palette='viridis', hue=country_sales.index, legend=False)
plt.title('Market Analysis: Top 10 Countries by Total Revenue', fontsize=15, fontweight='bold')
plt.xlabel('Total Revenue (USD)', fontsize=12)
plt.ylabel('Country', fontsize=12)
plt.tight_layout()
plt.savefig('images/top_countries_sales.png', dpi=300)
plt.close()
...
plt.figure(figsize=(12, 6))
sns.barplot(x=product_qty.values, y=product_qty.index, palette='mako', hue=product_qty.index, legend=False)
plt.title('Product Analysis: Top 10 Best Sellers (Quantity)', fontsize=15, fontweight='bold')
plt.xlabel('Total Quantity Sold', fontsize=12)
plt.ylabel('Product Description', fontsize=12)
plt.tight_layout()
plt.savefig('images/top_products_quantity.png', dpi=300)
plt.close()

# Which products generate the highest revenue?
product_rev = df.groupby('Description')['TotalRevenue'].sum().sort_values(ascending=False).head(10)
plt.figure(figsize=(12, 6))
sns.barplot(x=product_rev.values, y=product_rev.index, palette='rocket', hue=product_rev.index, legend=False)
plt.title('Revenue Analysis: Top 10 Revenue Generating Products', fontsize=15, fontweight='bold')
plt.xlabel('Total Revenue (USD)', fontsize=12)
plt.ylabel('Product Description', fontsize=12)
plt.tight_layout()
plt.savefig('images/top_products_revenue.png', dpi=300)
plt.close()
